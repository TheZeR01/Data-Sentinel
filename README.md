...
Nota al margen: Al momento de escribir esto evaluo usar PacketEvents de ProtocolLib para tener acceso mas directo al protocolo de red de Minecraft (pero sigo aprendiendo y soy bastante lento), por ahora el proyecto se enfoca SOLO en usar Análisis Semántico para obtener movimiento consistente de Biometría Conductual que analizar y con el cual entrenar al modelo en patrones que se puedan aplicar a otros proyectos, es una prueba conceptual en mi tiempo libre que espero escalar y poder contrastar con datos futuros... Evaluo opciones y escucho sugerencias
